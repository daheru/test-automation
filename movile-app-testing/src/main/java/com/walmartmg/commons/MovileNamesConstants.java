...
public final class MovileNamesConstants {
	...
	public static final String CREATE_BUTTON = PropertiesValuesUtil.getPropertyName("CREATE_BUTTON");
	
	public static final String CAR = PropertiesValuesUtil.getPropertyName("CAR");
