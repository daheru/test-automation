...
public enum MenusEnum {
	...
	DEP_VIDEOGAMES("videojuegos", new String[]{ NamesMobileElements.DEP_ITEM, NamesMobileElements.DEP_ITEM_CHILD }, new String[] { "playstation 3", "one", "nintendo", "switch", "playstation 4", "360", "pc", "retro", "destacados", "lanzamientos" }),
